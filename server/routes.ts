...
// applyProfilePrices extraido para server/services/pricing/profilePrices.ts
// para reuso pela pipeline antiga e pelo motor Vision Direta.
import { applyProfilePrices } from "./services/pricing/profilePrices";
